...
def set_loader(opt):
    ...
    if opt.dataset == 'cifar10':
        train_dataset = CIFAR10_noisy(root=opt.data_folder,
                                        corruption_prob = opt.noise_rate,
                                        corruption_type = opt.corruption_type,
        ...
        train_dataset = CIFAR100_noisy(root=opt.data_folder,
                                        corruption_prob = opt.noise_rate,
                                        corruption_type = opt.corruption_type,
                                        transform=train_transform,
                                        download=True)
